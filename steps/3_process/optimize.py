...
path_l = '~/Hailo8l/model/runs/detect/retrain_yolov8n/weights/'
...
nms_postprocess("~/Hailo8l/config/postprocess_config/yolov8n_nms_config.json", meta_arch=yolov8, engine=cpu)
'''
